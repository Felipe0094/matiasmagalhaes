          ...
          {contactInfo.map((item, index) => {
            ...
            const wrapperProps: any = item.link
              ? {
                  ...
                  className:
                    "bg-card rounded-xl p-8 text-center shadow-md hover:shadow-xl transition-all border border-border hover:border-accent/50 group block h-full flex flex-col items-center justify-center"
                }
              : {
                  className:
                    "bg-card rounded-xl p-8 text-center shadow-md hover:shadow-xl transition-all border border-border group h-full flex flex-col items-center justify-center"
                };
